...
//            var itemsC: [TableAdapterItem] = []
            ...
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 0, selectted: true,  text: "US 6",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 1, selectted: false, text: "US 7",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 2, selectted: false, text: "US 7",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 3, selectted: false, text: "US 8",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 4, selectted: false, text: "US 9",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 5, selectted: false, text: "US 10",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            itemsCC.append( SportTagSizeColorItem(state: .init(index: 6, selectted: false, text: "US 11",  handlers: .init(onClickAt: { i in
                self.updateTagCellIndex(i, section: 0)
            }))))
            ...
            itemsTT.append( SportTagSizeColorItem(state: .init(index: 0, borderColor: .orange, backColor: .white, centerColor: colorREd,  handlers: .init(onClickAt: { i in
//                self.updateTagCellIndex(i, section: 1)
            }))))
            itemsTT.append( SportTagSizeColorItem(state: .init(index: 1, borderColor: .clear,  backColor: .white, centerColor: colorGreen,  handlers: .init(onClickAt: { i in
//                self.updateTagCellIndex(i, section: 1)
            }))))
            itemsTT.append( SportTagSizeColorItem(state: .init(index: 2, borderColor: .clear,  backColor: colorYe, centerColor: colorGray,  handlers: .init(onClickAt: { i in
//                self.updateTagCellIndex(i, section: 1)
            }))))
